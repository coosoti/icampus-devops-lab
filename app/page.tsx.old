      ...
      <section style={{
        ...
        <div className="hero-grid" style={{ maxWidth: 1280, margin: "0 auto", padding: "0 1.5rem", position: "relative" }}>
          ...
          <div style={{ padding: "3rem 0" }}>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontWeight: 300, fontSize: "clamp(0.875rem, 2vw, 0.975rem)", color: "var(--text-secondary)", lineHeight: 1.75, maxWidth: 420, marginBottom: "2rem" }}>
          ...
          {/* Right — terminal card (hidden on mobile via CSS) */}
          <div className="hero-graphic">
            {/* Glow */}
            <div style={{ position: "absolute", width: 300, height: 300, borderRadius: "50%", background: "radial-gradient(circle, rgba(59,130,246,0.1) 0%, transparent 70%)", top: "50%", left: "50%", transform: "translate(-50%,-50%)", pointerEvents: "none" }} />
      ...
      <section style={{ maxWidth: 1280, margin: "0 auto", padding: "2.5rem 1.5rem 5rem" }}>
        ...
        {allProjects.length === 0 ? (
          <div style={{ textAlign: "center", padding: "5rem 0", fontFamily: "var(--font-mono)", color: "var(--text-muted)", fontSize: "0.85rem" }}>
            ...
            <Link href="/admin" style={{ color: "var(--accent-blue-bright)", textDecoration: "none" }}>
          ...
          <>
            {featured.length > 0 && (
              <div style={{ marginBottom: "2.5rem" }}>
                <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: "1rem" }}>
                  Featured
                </p>
